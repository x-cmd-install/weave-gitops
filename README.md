...
- **Latest release**: `v0.39.1-rc.1` (2026-01-25)
- **Last commit**: 2026-01-25
- **License**: Apache-2.0
- **Stars**: 1128 · **Forks**: 166 · **Open issues**: 1737 · **Contributors**: 99
...
See <https://x-cmd.com/install/weave-gitops> for details.

## Data

This mirror is auto-maintained by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action). Latest card snapshot: `data/card/260909.yml`. Merged card+release view: `data/latest.report.yml`.

_Last regenerated: 2026-09-09T04:55:54Z._
